  ...
  return (
    <div className="min-h-screen bg-zinc-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden z-0 pointer-events-none">
        ...
        <div className="absolute top-[50%] -right-[10%] w-[50%] h-[50%] rounded-full bg-emerald-50/40 blur-3xl" />
      </div>
            ...
            <div>
              ...
              <div className="mt-1">
                ...
                <p className="mt-1.5 text-xs text-zinc-400">
                  * En production, l'accès médecin ferait l'objet d'une validation KMS.
                </p>
              </div>
            </div>
